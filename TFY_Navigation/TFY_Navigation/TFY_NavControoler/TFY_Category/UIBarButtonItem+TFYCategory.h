 ...
 */
@property(nonatomic,copy,readonly)UIBarButtonItem *(^tfy_titleItembtn)(CGSize,NSString *,id,UIFont *,UIImage *,NAV_ButtonImageDirection,CGFloat,id, SEL,UIControlEvents);
